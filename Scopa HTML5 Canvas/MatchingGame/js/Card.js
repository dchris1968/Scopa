...
function Card(ordinal, suit) {
    ...
    self.init = function() {        
        self.ord = ordinal;
        self.suit = suit;
        self.cardBackPath = "Cards/back.png";
        self.cardFrontPath = "Cards/"+self.ord+"Of"+self.suit+".jpg";       
    ...
    self.drawCard = function() {        
        self.cardBack = paper.image( self.cardBackPath, self.xPos, self.yPos, 100, 150)
        self.cardFront = paper.image(self.cardFrontPath, self.xPos, self.yPos, 100, 150)
    ...
    self.toString = function() {
        return "Card:"+self.ord+"Of"+self.suit;
    }
